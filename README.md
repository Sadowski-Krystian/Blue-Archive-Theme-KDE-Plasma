...
If you use the files right now, your KDE applications will use the signature *Blue Archive* color palette (crisp whites, vibrant blues, and soft accents), but the custom UI elements, panels, and borders are not included yet.
